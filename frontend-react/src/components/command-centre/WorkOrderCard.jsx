  ...
  return (
    <div className="flex flex-col gap-3 rounded-md border border-border bg-bg-card p-4 shadow-card-sm">
      <div className="flex items-center justify-between">
        ...
        <span className="text-[11px] font-bold text-text-muted">{workOrder.id}</span>
      </div>

      <h4 className="text-[14px] font-bold leading-snug text-text-primary">{workOrder.title}</h4>
      <div className="flex items-center gap-1.5 text-[12px] text-text-secondary">
        <i className="fa-solid fa-map-pin text-accent-blue" /> {workOrder.asset_name}
      </div>
      ...
      <div className="flex flex-col gap-1.5 rounded-sm border border-border-light bg-bg-surface px-3 py-2.5 text-[12px] text-text-secondary">
        <div>
          <strong className="text-text-primary">Contractor:</strong> {workOrder.contractor}
        </div>
        <div>
          <strong className="text-text-primary">Target Deadline:</strong> {workOrder.deadline}
        </div>
        <div>
        ...
        <div>
          <strong className="text-text-primary">Method:</strong> {workOrder.repair_method}
        </div>
      </div>
